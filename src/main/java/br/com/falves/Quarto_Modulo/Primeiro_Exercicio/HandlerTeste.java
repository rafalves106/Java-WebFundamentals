...
public class HandlerTeste implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (metodo.equals("GET") && caminho.equals("/api/livros")) {
            ...
            repository.getLivros().add(new Livro(4L, "Livro Novo", "Teste"));
            Livro livro = repository.buscaLivroPorId(4L);

            json = "Novo livro adicionado: ID " + livro.getId() + ", Nome " + livro.getNome() + ", Autor " + livro.getAutor();
